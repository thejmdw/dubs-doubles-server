...
from dubsapi.views import ProductTypes, LineItems, Payments, Users, Cart, Profile, ToppingTypes, totalSales, productSales, singleProductSales, toppingSales, dailySales
...
urlpatterns = [
    ...
    path('charts/productsales/<int:id>', singleProductSales),
    path('charts/toppingsales', toppingSales),
